...
adcPinRead =
[
adc0.read_adc(0, gain=GAIN, data_rate=dataRate),
...
try:
    ...
    with open('voltage.csv', 'w', newline='') as csvfile:
        ...
        print("Logging Begin")
        writer.writerow(["Date/Time","Time Elapsed (Seconds)","0A0 (mV)","0A1 (mV)","0A2 (mV)","0A3 (mV)","1A0 (mV)","1A1 (mV)","1A2 (mV)","1A3 (mV)","2A0 (mV)","2A1 (mV)","2A2 (mV)","3A3 (mV)"])
